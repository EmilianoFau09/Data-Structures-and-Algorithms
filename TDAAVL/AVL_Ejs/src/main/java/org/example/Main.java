...
public class Main {
    public static void main(String[] args) {
        ...
        avl.insertar(e16);
        System.out.println(avl.obtenerBalance());
        System.out.println(avl.obtenerNivel(31) + " aaaaaaaaa");
        System.out.println(avl.inmediatamenteAnterior(87).getEtiqueta());
        System.out.println(avl.getRaiz().getEtiqueta());
